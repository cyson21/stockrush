...
./tools/local-e2e/local-e2e kafka-outage-recovery \
  ...
  --kafka-service kafka \
  --catalog-url http://localhost:28081 \
  --inventory-url http://localhost:28082 \
  --order-url http://localhost:28083 \
  --order-api-url http://localhost:28080 \
  --outbox-api-url http://localhost:28080 \
  --payment-url http://localhost:28084 \
  --promotion-url http://localhost:28085 \
