...
- Mobile customer app now has the Expo scaffold, Gateway-first API client, product/SKU stock screen tests, coupon quote tests, and order creation payload/header tests. Status tracking, order history, Android/iOS smoke evidence, and screenshots remain future scope.
