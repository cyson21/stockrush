...
- demo stack automatic relay smoke에서 productCode `DEMO-E2E-20260514185221-1950a3d2`, SKU `DEMO-E2E-20260514185221-1950a3d2-S`를 사용했다. `CARD` 주문 `ord_20260514095221_d9fbc1ad`는 `CONFIRMED/COMPLETED`, `FAIL_CARD` 주문 `ord_20260514095221_45a55983`와 `DELAY_CARD` 주문 `ord_20260514095221_22945065`는 `CANCELLED/FAILED`가 됐다. 최종 재고는 `availableQuantity=19`, `reservedQuantity=0`이고 Order/Inventory/Payment `pendingOutboxDelta`는 모두 0이었다.
