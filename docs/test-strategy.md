...
| Web visual smoke | 고객/관리자 앱의 desktop/mobile layout, 주요 텍스트 노출, 빈 화면 여부, 스크린샷 산출 확인 | `tools/web-screenshots/capture-web-screenshots.mjs`, `docs/runbooks/web-visual-smoke.md`, `docs/assets/screenshots/` |
