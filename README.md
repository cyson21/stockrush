...
- `./tools/architecture-guard/architecture-guard check`로 schema ownership, Controller 반환 타입, 이벤트 envelope, Outbox table shape, Gateway Correlation ID 전파, Actuator 운영 endpoint 노출을 점검합니다.
