...
class CorrelationIdFilter extends OncePerRequestFilter {
    ...
    private static String resolve(String correlationId) {
    ...
    private static boolean isCorrelationHeader(String name) {
        return name != null && HEADER_NAME.equalsIgnoreCase(name);
    }
    ...
    private static final class CorrelationHeaderRequest extends HttpServletRequestWrapper {
        ...
        public Enumeration<String> getHeaderNames() {
            ...
            while (originalNames.hasMoreElements()) {
                String headerName = originalNames.nextElement();
                headerNames.add(isCorrelationHeader(headerName) ? HEADER_NAME : headerName);
            }
